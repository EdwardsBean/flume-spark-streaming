...
//        jedis.hset(imei,appName,currentTime)
  ...
  def AppDownloadCount(source: DStream[UserDownload],duration:Duration): DStream[(String, Int)] = {
...
//        //聚合下载量
//        jedis.hincrBy(appName,"downCount",downCount)
//        //通知下载量已变更
...
//    }
  ...
  def main(args: Array[String]) {
    ...
    val downloadCount = AppDownloadCount(cleanSource,Seconds(2))
